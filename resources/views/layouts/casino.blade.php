                        ...
                        @guest
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                @if (Route::has('posts.index'))
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ route('posts.index') }}">Access to blog</a>
                                    </li>
                                @endif
                            </ul>
                        ...
                        @else
                            ...
                            <ul class="navbar-nav d-flex">
                                <li class="nav-item dropdown dropstart list-style-none">
                                    <button role="button" type="button" class="btn btn-clear-secondary text-white" id="navbarDropdown" data-bs-toggle="dropdown" aria-expanded="false"> 
